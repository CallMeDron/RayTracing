...
class TPlane {
  public:
    ...
    TPlane(const TPoint& point, const TVector& vector1, const TVector& vector2);
    TPlane(const TPoint& point1, const TPoint& point2, const TPoint& point3);
    TPlane(const TPoint& point, const TLine& line);
    TPlane(const TLine& line1, const TLine& line2);
